...
from .api import auth, users, comments, classification, dashboard, invites, accounts, clusters, ai
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info(f"Environment: {'production' if settings.production else 'development'}")
